      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button onClick={() => setLocation("/categories")} className="hover:text-blue-600 font-medium">Categories</button>
    ...
    Customer Login
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-gray-50 border-t border-gray-200 p-4 space-y-2">
            ...
            <button onClick={() => { setLocation("/categories"); setMobileMenuOpen(false); }} className="block w-full text-left py-2 px-3 hover:bg-gray-200 rounded font-medium">Categories</button>
            <button 

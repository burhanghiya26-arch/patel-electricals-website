...
export default function AdminSalesmen() {
  ...
  const commissionReport = trpc.salesman.commissionReport.useQuery({ days: 30 }, { enabled });
  ...
  return <div className="min-h-screen bg-background">
    ...
    <main className="container space-y-6 py-8">
      ...
      <Card><CardHeader><CardTitle>Commission Report — Last 30 Days</CardTitle><CardDescription>Sirf delivered salesman orders ka payable commission.</CardDescription></CardHeader><CardContent>
